...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "eduCourse", Name: "eduCourse", Component: "view/eduCourse/eduCourse.vue", Sort: 2, Meta: Meta{Title: "课程管理", Icon: "collection"}},
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "eduEnrollment", Name: "eduEnrollment", Component: "view/eduEnrollment/eduEnrollment.vue", Sort: 3, Meta: Meta{Title: "报名管理", Icon: "document"}},
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "eduClassSession", Name: "eduClassSession", Component: "view/eduClassSession/eduClassSession.vue", Sort: 4, Meta: Meta{Title: "课时记录", Icon: "tickets"}},
	}
