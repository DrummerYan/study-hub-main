...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		...
		{AuthorityId: 9001, AuthorityName: "教师", ParentId: utils.Pointer[uint](888), DefaultRouter: "dashboard"},
		{AuthorityId: 9002, AuthorityName: "学员", ParentId: utils.Pointer[uint](888), DefaultRouter: "dashboard"},
		{AuthorityId: 9003, AuthorityName: "教务管理员", ParentId: utils.Pointer[uint](888), DefaultRouter: "dashboard"},
	}
...
func (i *initAuthority) DataInserted(ctx context.Context) bool {
	...
	if errors.Is(db.Where("authority_id = ?", "9003").
