                        ...
                        <el-dropdown>
                          <div class="dp-flex justify-content-center align-items height-full width-full">
                            <span class="header-avatar" style="cursor: pointer">
                              <CustomPic />
                              <span v-show="!isMobile" style="margin-left: 5px">{{ userStore.userInfo.authority?.authorityName || userStore.userInfo.nickName }}</span>
                              <el-icon>
                                <arrow-down />
                              </el-icon>
                            </span>
                          ...
                          <template #dropdown>
                            <el-dropdown-menu class="dropdown-group">
                              ...
                              <template v-if="userStore.userInfo.authorities">
                                <el-dropdown-item v-for="item in userStore.userInfo.authorities.filter(i=>i.authorityId!==userStore.userInfo.authorityId && i.authorityName!=='普通用户子角色')" :key="item.authorityId" @click="changeUserAuth(item.authorityId)">
                                  <span>
