...
// @accept application/json
// @Produce application/json
// @Param data body object true "消课参数"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"消课成功"}"
// @Router /eduEnrollment/consumptionClass [post]
...
// @accept application/json
// @Produce application/json
// @Param data body object true "加课参数"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"加课成功"}"
// @Router /eduEnrollment/addSession [post]
